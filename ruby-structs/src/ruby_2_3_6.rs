...
impl st_table {
    ...
    #[inline]
    pub unsafe fn entries_packed_raw(this: *const Self) -> ::std::os::raw::c_uint {
        unsafe {
    ...
    #[inline]
    pub unsafe fn set_entries_packed_raw(this: *mut Self, val: ::std::os::raw::c_uint) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
    ...
    #[inline]
    pub unsafe fn num_entries_raw(this: *const Self) -> st_index_t {
        unsafe {
            ::std::mem::transmute(<__BindgenBitfieldUnit<[u8; 8usize]>>::raw_get(
                ::std::ptr::addr_of!((*this)._bitfield_1),
                1usize,
    ...
    #[inline]
    pub unsafe fn set_num_entries_raw(this: *mut Self, val: st_index_t) {
        unsafe {
            let val: usize = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 8usize]>>::raw_set(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
...
pub const ruby_method_ids_idNULL: ruby_method_ids = 151;
pub const ruby_method_ids_idEmptyP: ruby_method_ids = 152;
pub const ruby_method_ids_idEqlP: ruby_method_ids = 153;
pub const ruby_method_ids_idRespond_to: ruby_method_ids = 154;
pub const ruby_method_ids_idRespond_to_missing: ruby_method_ids = 155;
pub const ruby_method_ids_idIFUNC: ruby_method_ids = 156;
pub const ruby_method_ids_idCFUNC: ruby_method_ids = 157;
pub const ruby_method_ids_id_core_set_method_alias: ruby_method_ids = 158;
pub const ruby_method_ids_id_core_set_variable_alias: ruby_method_ids = 159;
pub const ruby_method_ids_id_core_undef_method: ruby_method_ids = 160;
pub const ruby_method_ids_id_core_define_method: ruby_method_ids = 161;
pub const ruby_method_ids_id_core_define_singleton_method: ruby_method_ids = 162;
pub const ruby_method_ids_id_core_set_postexe: ruby_method_ids = 163;
pub const ruby_method_ids_id_core_hash_from_ary: ruby_method_ids = 164;
pub const ruby_method_ids_id_core_hash_merge_ary: ruby_method_ids = 165;
...
pub const ruby_method_ids_tFreeze: ruby_method_ids = 170;
pub const ruby_method_ids_tInspect: ruby_method_ids = 171;
pub const ruby_method_ids_tIntern: ruby_method_ids = 172;
pub const ruby_method_ids_tObject_id: ruby_method_ids = 173;
pub const ruby_method_ids_tConst_missing: ruby_method_ids = 174;
pub const ruby_method_ids_tMethodMissing: ruby_method_ids = 175;
pub const ruby_method_ids_tMethod_added: ruby_method_ids = 176;
pub const ruby_method_ids_tSingleton_method_added: ruby_method_ids = 177;
pub const ruby_method_ids_tMethod_removed: ruby_method_ids = 178;
pub const ruby_method_ids_tSingleton_method_removed: ruby_method_ids = 179;
pub const ruby_method_ids_tMethod_undefined: ruby_method_ids = 180;
pub const ruby_method_ids_tSingleton_method_undefined: ruby_method_ids = 181;
pub const ruby_method_ids_tLength: ruby_method_ids = 182;
pub const ruby_method_ids_tSize: ruby_method_ids = 183;
pub const ruby_method_ids_tGets: ruby_method_ids = 184;
pub const ruby_method_ids_tSucc: ruby_method_ids = 185;
pub const ruby_method_ids_tEach: ruby_method_ids = 186;
pub const ruby_method_ids_tProc: ruby_method_ids = 187;
pub const ruby_method_ids_tLambda: ruby_method_ids = 188;
pub const ruby_method_ids_tSend: ruby_method_ids = 189;
pub const ruby_method_ids_t__send__: ruby_method_ids = 190;
pub const ruby_method_ids_t__attached__: ruby_method_ids = 191;
pub const ruby_method_ids_tInitialize: ruby_method_ids = 192;
pub const ruby_method_ids_tInitialize_copy: ruby_method_ids = 193;
pub const ruby_method_ids_tInitialize_clone: ruby_method_ids = 194;
pub const ruby_method_ids_tInitialize_dup: ruby_method_ids = 195;
pub const ruby_method_ids_tTo_int: ruby_method_ids = 196;
pub const ruby_method_ids_tTo_ary: ruby_method_ids = 197;
pub const ruby_method_ids_tTo_str: ruby_method_ids = 198;
pub const ruby_method_ids_tTo_sym: ruby_method_ids = 199;
pub const ruby_method_ids_tTo_hash: ruby_method_ids = 200;
pub const ruby_method_ids_tTo_proc: ruby_method_ids = 201;
pub const ruby_method_ids_tTo_io: ruby_method_ids = 202;
pub const ruby_method_ids_tTo_a: ruby_method_ids = 203;
pub const ruby_method_ids_tTo_s: ruby_method_ids = 204;
pub const ruby_method_ids_tTo_i: ruby_method_ids = 205;
...
pub const ruby_method_ids_tUScore: ruby_method_ids = 211;
pub const ruby_method_ids_tNEXT_ID: ruby_method_ids = 212;
pub const ruby_method_ids_idFreeze: ruby_method_ids = 2721;
pub const ruby_method_ids_idInspect: ruby_method_ids = 2737;
pub const ruby_method_ids_idIntern: ruby_method_ids = 2753;
pub const ruby_method_ids_idObject_id: ruby_method_ids = 2769;
pub const ruby_method_ids_idConst_missing: ruby_method_ids = 2785;
pub const ruby_method_ids_idMethodMissing: ruby_method_ids = 2801;
pub const ruby_method_ids_idMethod_added: ruby_method_ids = 2817;
pub const ruby_method_ids_idSingleton_method_added: ruby_method_ids = 2833;
pub const ruby_method_ids_idMethod_removed: ruby_method_ids = 2849;
pub const ruby_method_ids_idSingleton_method_removed: ruby_method_ids = 2865;
pub const ruby_method_ids_idMethod_undefined: ruby_method_ids = 2881;
pub const ruby_method_ids_idSingleton_method_undefined: ruby_method_ids = 2897;
pub const ruby_method_ids_idLength: ruby_method_ids = 2913;
pub const ruby_method_ids_idSize: ruby_method_ids = 2929;
pub const ruby_method_ids_idGets: ruby_method_ids = 2945;
pub const ruby_method_ids_idSucc: ruby_method_ids = 2961;
pub const ruby_method_ids_idEach: ruby_method_ids = 2977;
pub const ruby_method_ids_idProc: ruby_method_ids = 2993;
pub const ruby_method_ids_idLambda: ruby_method_ids = 3009;
pub const ruby_method_ids_idSend: ruby_method_ids = 3025;
pub const ruby_method_ids_id__send__: ruby_method_ids = 3041;
pub const ruby_method_ids_id__attached__: ruby_method_ids = 3057;
pub const ruby_method_ids_idInitialize: ruby_method_ids = 3073;
pub const ruby_method_ids_idInitialize_copy: ruby_method_ids = 3089;
pub const ruby_method_ids_idInitialize_clone: ruby_method_ids = 3105;
pub const ruby_method_ids_idInitialize_dup: ruby_method_ids = 3121;
pub const ruby_method_ids_idTo_int: ruby_method_ids = 3137;
pub const ruby_method_ids_idTo_ary: ruby_method_ids = 3153;
pub const ruby_method_ids_idTo_str: ruby_method_ids = 3169;
pub const ruby_method_ids_idTo_sym: ruby_method_ids = 3185;
pub const ruby_method_ids_idTo_hash: ruby_method_ids = 3201;
pub const ruby_method_ids_idTo_proc: ruby_method_ids = 3217;
pub const ruby_method_ids_idTo_io: ruby_method_ids = 3233;
pub const ruby_method_ids_idTo_a: ruby_method_ids = 3249;
pub const ruby_method_ids_idTo_s: ruby_method_ids = 3265;
pub const ruby_method_ids_idTo_i: ruby_method_ids = 3281;
...
pub const ruby_method_ids_idUScore: ruby_method_ids = 3377;
...
pub const imemo_type_imemo_none: imemo_type = 0;
...
pub const imemo_type_imemo_mask: imemo_type = 7;
