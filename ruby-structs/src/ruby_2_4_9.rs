...
pub const ruby_method_ids_tInitialize: ruby_method_ids = 194;
pub const ruby_method_ids_tInitialize_copy: ruby_method_ids = 195;
pub const ruby_method_ids_tInitialize_clone: ruby_method_ids = 196;
pub const ruby_method_ids_tInitialize_dup: ruby_method_ids = 197;
pub const ruby_method_ids_tTo_int: ruby_method_ids = 198;
pub const ruby_method_ids_tTo_ary: ruby_method_ids = 199;
pub const ruby_method_ids_tTo_str: ruby_method_ids = 200;
pub const ruby_method_ids_tTo_sym: ruby_method_ids = 201;
pub const ruby_method_ids_tTo_hash: ruby_method_ids = 202;
pub const ruby_method_ids_tTo_proc: ruby_method_ids = 203;
pub const ruby_method_ids_tTo_io: ruby_method_ids = 204;
pub const ruby_method_ids_tTo_a: ruby_method_ids = 205;
pub const ruby_method_ids_tTo_s: ruby_method_ids = 206;
pub const ruby_method_ids_tTo_i: ruby_method_ids = 207;
pub const ruby_method_ids_tBt: ruby_method_ids = 208;
pub const ruby_method_ids_tBt_locations: ruby_method_ids = 209;
pub const ruby_method_ids_tCall: ruby_method_ids = 210;
pub const ruby_method_ids_tMesg: ruby_method_ids = 211;
pub const ruby_method_ids_tException: ruby_method_ids = 212;
...
pub const ruby_method_ids_idInitialize: ruby_method_ids = 3105;
pub const ruby_method_ids_idInitialize_copy: ruby_method_ids = 3121;
pub const ruby_method_ids_idInitialize_clone: ruby_method_ids = 3137;
pub const ruby_method_ids_idInitialize_dup: ruby_method_ids = 3153;
pub const ruby_method_ids_idTo_int: ruby_method_ids = 3169;
pub const ruby_method_ids_idTo_ary: ruby_method_ids = 3185;
pub const ruby_method_ids_idTo_str: ruby_method_ids = 3201;
pub const ruby_method_ids_idTo_sym: ruby_method_ids = 3217;
pub const ruby_method_ids_idTo_hash: ruby_method_ids = 3233;
pub const ruby_method_ids_idTo_proc: ruby_method_ids = 3249;
pub const ruby_method_ids_idTo_io: ruby_method_ids = 3265;
pub const ruby_method_ids_idTo_a: ruby_method_ids = 3281;
pub const ruby_method_ids_idTo_s: ruby_method_ids = 3297;
pub const ruby_method_ids_idTo_i: ruby_method_ids = 3313;
pub const ruby_method_ids_idBt: ruby_method_ids = 3329;
pub const ruby_method_ids_idBt_locations: ruby_method_ids = 3345;
pub const ruby_method_ids_idCall: ruby_method_ids = 3361;
pub const ruby_method_ids_idMesg: ruby_method_ids = 3377;
pub const ruby_method_ids_idException: ruby_method_ids = 3393;
...
impl rb_compile_option_struct {
    ...
    #[inline]
    pub unsafe fn trace_instruction_raw(this: *const Self) -> ::std::os::raw::c_uint {
        unsafe {
            ::std::mem::transmute(<__BindgenBitfieldUnit<[u8; 2usize]>>::raw_get(
                ::std::ptr::addr_of!((*this)._bitfield_1),
                7usize,
    ...
    #[inline]
    pub unsafe fn set_trace_instruction_raw(this: *mut Self, val: ::std::os::raw::c_uint) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 2usize]>>::raw_set(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
