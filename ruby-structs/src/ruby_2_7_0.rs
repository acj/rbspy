...
fn bindgen_test_layout_rb_call_cache() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_cache>())).method_serial as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_call_cache),
...
impl ::std::fmt::Debug for rb_call_cache {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write ! (f , "rb_call_cache {{ method_state: {:?}, class_serial: {:?}, me: {:?}, method_serial: {:?}, call: {:?}, aux: {:?} }}" , self . method_state , self . class_serial , self . me , self . method_serial , self . call , self . aux)
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_rb_call_data() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_data>())).cc as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_data>())).ci as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_call_data),
...
fn bindgen_test_layout_iseq_inline_iv_cache_entry() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<iseq_inline_iv_cache_entry>())).ic_serial as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<iseq_inline_iv_cache_entry>())).index as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_rb_iseq_constant_body() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_iseq_constant_body>())).iseq_unique_id as *const _ as usize
        },
        280usize,
        concat!(
            "Offset of field: ",
...
impl ::std::fmt::Debug for rb_vm_struct__bindgen_ty_1 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "rb_vm_struct__bindgen_ty_1 {{ cmd: [{}] }}",
            self.cmd
                .iter()
                .enumerate()
