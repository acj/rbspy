...
#[test]
fn bindgen_test_layout_rb_darray_meta() {
    assert_eq!(
        ::std::mem::size_of::<rb_darray_meta>(),
        8usize,
        concat!("Size of: ", stringify!(rb_darray_meta))
    );
    assert_eq!(
        ::std::mem::align_of::<rb_darray_meta>(),
        4usize,
        concat!("Alignment of ", stringify!(rb_darray_meta))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_darray_meta>())).size as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_darray_meta),
            "::",
            stringify!(size)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_darray_meta>())).capa as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_darray_meta),
...
fn bindgen_test_layout_iseq_inline_constant_cache_entry() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<iseq_inline_constant_cache_entry>())).ic_padding as *const _
                as usize
        },
        24usize,
        concat!(
...
fn bindgen_test_layout_iseq_inline_constant_cache() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<iseq_inline_constant_cache>())).get_insn_idx as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_rb_iseq_constant_body() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_iseq_constant_body>())).yjit_blocks as *const _ as usize
        },
        288usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_rb_control_frame_struct() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_control_frame_struct>())).jit_return as *const _ as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_rb_thread_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_thread_struct>())).tid as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_thread_struct),
...
fn bindgen_test_layout_iseq_compile_data() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<iseq_compile_data>())).in_rescue as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(iseq_compile_data),
...
fn bindgen_test_layout_iseq_insn_info_entry() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<iseq_insn_info_entry>())).node_id as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(iseq_insn_info_entry),
