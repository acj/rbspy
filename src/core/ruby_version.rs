...
ruby_version_v3_3_x!(ruby_3_3_12);
...
ruby_version_v4_0_x!(ruby_4_0_6);
...
mod tests {
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_3_12() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_3_12::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_4_0_6() {
        let source = coredump_4_0_0();
        let vm_addr = 0x7fa56b875738;
        let global_symbols_addr = Some(0x7fa56b862b50);
        let stack_trace = ruby_version::ruby_4_0_6::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
