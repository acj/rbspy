...
macro_rules! get_execution_context_from_vm(
    () => (
        pub fn get_execution_context<T: ProcessMemory>(
            ...
            // Fast path: on a previous sample we located the word inside the main ractor struct
            // that holds the execution context pointer. That word's address never changes (the
            // main ractor lives for the life of the process), so we can re-read just the pointer
            // instead of re-scanning the VM and ractor structs on every sample. The pointer's
            // value does change as the target switches threads, hence the fresh read here.
            if let Some(slot) = cache.ec_pointer_slot() {
                match source.copy_struct::<usize>(slot) {
                    ...
                    // The slot no longer holds a valid execution context pointer; fall through
                    // to a full scan, which re-caches the slot if it succeeds.
...
ruby_version_v3_2_x!(ruby_3_2_11);
...
ruby_version_v3_3_x!(ruby_3_3_10);
ruby_version_v3_3_x!(ruby_3_3_11);
...
ruby_version_v3_3_x!(ruby_3_4_9);
ruby_version_v3_3_x!(ruby_3_4_10);
ruby_version_v4_0_x!(ruby_4_0_0);
ruby_version_v4_0_x!(ruby_4_0_1);
ruby_version_v4_0_x!(ruby_4_0_2);
ruby_version_v4_0_x!(ruby_4_0_3);
ruby_version_v4_0_x!(ruby_4_0_4);
ruby_version_v4_0_x!(ruby_4_0_5);
...
mod tests {
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_2_11() {
        let source = coredump_3_2_0();
        let vm_addr = 0xffffb8034578;
        let global_symbols_addr = Some(0xffffb8025340);
        let stack_trace = ruby_version::ruby_3_2_11::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_3_9() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_3_9::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_3_10() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_3_10::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_3_11() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_3_11::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_4_8() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_4_8::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_4_9() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_4_9::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_3_4_10() {
        let source = coredump_3_3_0();
        let vm_addr = 0x7f43435f4988;
        let global_symbols_addr = Some(0x7f43435e3c60);
        let stack_trace = ruby_version::ruby_3_4_10::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_4_0_2() {
        let source = coredump_4_0_0();
        let vm_addr = 0x7fa56b875738;
        let global_symbols_addr = Some(0x7fa56b862b50);
        let stack_trace = ruby_version::ruby_4_0_2::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_4_0_3() {
        let source = coredump_4_0_0();
        let vm_addr = 0x7fa56b875738;
        let global_symbols_addr = Some(0x7fa56b862b50);
        let stack_trace = ruby_version::ruby_4_0_3::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[cfg(target_pointer_width = "64")]
    #[test]
    fn test_get_ruby_stack_trace_4_0_4() {
        let source = coredump_4_0_0();
        let vm_addr = 0x7fa56b875738;
        let global_symbols_addr = Some(0x7fa56b862b50);
        let stack_trace = ruby_version::ruby_4_0_4::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
    ...
    #[test]
    fn test_get_ruby_stack_trace_4_0_5() {
        let source = coredump_4_0_0();
        let vm_addr = 0x7fa56b875738;
        let global_symbols_addr = Some(0x7fa56b862b50);
        let stack_trace = ruby_version::ruby_4_0_5::get_stack_trace::<CoreDump>(
            0,
            vm_addr,
            global_symbols_addr,
            &source,
