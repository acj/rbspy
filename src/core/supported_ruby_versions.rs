...
pub fn get(v: &str) -> Result<RubyVersion> {
    match v {
        ...
        "3.5.0" => Ok(RubyVersion {
            semver_version: Version::new(3, 5, 0),
            get_execution_context_fn: super::ruby_version::ruby_3_5_0::get_execution_context,
            get_stack_trace_fn: super::ruby_version::ruby_3_5_0::get_stack_trace,
            is_maybe_thread_fn: super::ruby_version::ruby_3_5_0::is_maybe_thread,
        }),
